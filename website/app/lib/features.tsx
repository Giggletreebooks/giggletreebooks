...
/** 24px Lucide-style outline paths, inherit colour and stroke from the card. */
const iconProps = {
  viewBox: "0 0 24 24",
  fill: "none",
  stroke: "currentColor",
...
export const LEARNING_ICONS: ReactNode[] = [
  ...
  <svg {...iconProps} key="eye">
    <path d="M2 12s3.6-7 10-7 10 7 10 7-3.6 7-10 7-10-7-10-7Z" />
    <circle cx="12" cy="12" r="3" />
  </svg>,
  <svg {...iconProps} key="chat">
    <path d="M21 15a2 2 0 0 1-2 2H8l-5 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
    <path d="M8 9h8M8 13h5" />
  </svg>,
  <svg {...iconProps} key="compass">
    <circle cx="12" cy="12" r="9" />
    <path d="m15.5 8.5-2 5-5 2 2-5z" />
  </svg>,
  <svg {...iconProps} key="ruler">
    <path d="M3 15 15 3l6 6L9 21z" />
    <path d="m7 11 2 2M11 7l2 2M11 15l2 2" />
  </svg>,
  <svg {...iconProps} key="heart">
